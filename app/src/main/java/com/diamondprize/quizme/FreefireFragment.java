...
public class FreefireFragment extends Fragment {
    ...
    com.diamondprize.quizme.databinding.FragmentFreefireBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = com.diamondprize.quizme.databinding.FragmentFreefireBinding.inflate(inflater, container, false);
        ...
        // Load URL ke WebView
        String url = "https://nisrok-m.blogspot.com/p/free-fire.html"; // Ganti dengan URL yang ingin Anda tampilkan
        webView.loadUrl(url);
        ...
        InterstitialAd.load(context, getString(R.string.interstitial_ad_unit_id), adRequest,
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        ...
                        Toast.makeText(getContext(), "WITHDRAWS FREE FIRE", Toast.LENGTH_SHORT).show();
