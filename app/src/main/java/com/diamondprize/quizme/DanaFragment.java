...
public class DanaFragment extends Fragment {
    ...
    com.diamondprize.quizme.databinding.FragmentDanaBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = com.diamondprize.quizme.databinding.FragmentDanaBinding.inflate(inflater, container, false);
        ...
        // Load URL ke WebView
        String url = "https://nisrok-m.blogspot.com/p/e-wallet-dana.html"; // Ganti dengan URL yang ingin Anda tampilkan
        webView.loadUrl(url);
        ...
        InterstitialAd.load(context, getString(R.string.interstitial_ad_unit_id), adRequest,
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        ...
                        Toast.makeText(getContext(), "E-WALLET DANA", Toast.LENGTH_SHORT).show();
