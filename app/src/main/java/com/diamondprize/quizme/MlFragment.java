...
public class MlFragment extends Fragment {
    ...
    com.diamondprize.quizme.databinding.FragmentMlBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = com.diamondprize.quizme.databinding.FragmentMlBinding.inflate(inflater, container, false);
        ...
        // Load URL ke WebView
        String url = "https://nisrok-m.blogspot.com/p/mobile-legend-bang-bang.html"; // Ganti dengan URL yang ingin Anda tampilkan
        webView.loadUrl(url);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mNextLevelButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(user.getCoins() > 4500) {
                    String uid = FirebaseAuth.getInstance().getUid();
                    String payPal = binding.emailBox.getText().toString();
                    String jumlahkoin = binding.jumlahkoin.getText().toString();
                    freefire_withdraws request = new freefire_withdraws(uid, payPal, user.getName(), jumlahkoin);
                    database
                            .collection("mobilelegends_withdraws")
                            .document(uid)
        ...
        InterstitialAd.load(context, getString(R.string.interstitial_ad_unit_id), adRequest,
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        ...
                        Toast.makeText(getContext(), "WITHDRAWS MOBILE LEGENDS", Toast.LENGTH_SHORT).show();
